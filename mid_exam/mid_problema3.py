...
# # elimin duplicatele
#
# def my_function(dictionar):
#     a = list(dict.values(dictionar))
#     return list(dict.fromkeys(a))
#
#
# # sepoar valorile din dict in litere
# def combination_2letters_1(dictionar):
#     lista = my_function(dictionar)
...
# print(combination_2letters_1(dictionar))
# # print(my_function(dictionar))
